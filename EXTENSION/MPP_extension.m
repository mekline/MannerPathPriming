function MPP_Extension(subNo, condition)
...
try
    ...
    parameters.extTestMannerVid = vidNames(start_Index:end_Index, 43);
    parameters.extTestPathVid = vidNames(start_Index:end_Index, 44);
    parameters.extLetsFind = vidNames(start_Index:end_Index, 45);
    parameters.extWhichOne = vidNames(start_Index:end_Index, 46);
    parameters.extStarImage = vidNames(start_Index:end_Index, 47); 
    ...
    for i=1:ntrials
      ...
      %ADD TIME STAMPS! AND DIFFERENT ORDER FOR ANALYSIS
