...
try
    ...
    mannerSideBias(parameters.LorR_bias == 0) = 'L'
    mannerSideBias(parameters.LorR_bias == 1) = 'R'
    
    pathSideBias(parameters.LorR_bias == 0) = 'R'
    pathSideBias(parameters.LorR_bias == 1) = 'L'
    
    mannerSideFinal(parameters.LorR_final == 0) = 'L'
    mannerSideFinal(parameters.LorR_final == 1) = 'R'
    
    pathSideFinal(parameters.LorR_final == 0) = 'R'
    pathSideFinal(parameters.LorR_final == 1) = 'L'
