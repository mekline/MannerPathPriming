...
try
    ...
    if Conditions == 'Manner'
        i = mainItems.BiasManner
        [nrows,ncols,~] = size(mainItems.BiasManner)
        x = zeros(nrows+20,ncols+20,3)
        x(1:2:226,1:2:365,:) = 255
        x(11:end-10,11:end-10,:) = i

    else
        i = mainItems.BiasPath
        [nrows,ncols,~] = size(mainItems.BiasPath)
        x = zeros(nrows+20,ncols+20,3)
        x(1:2:226,1:2:365,:) = 255
        x(11:end-10,11:end-10,:) = i
    ...
    if Conditions == 'Manner'
        i = mainItems.TestManner
        [nrows,ncols,~] = size(mainItems.TestManner)
        x = zeros(nrows+20,ncols+20,3)
        x(1:2:226,1:2:365,:) = 255
        x(11:end-10,11:end-10,:) = i
    else
        i = mainItems.TestPath
        [nrows,ncols,~] = size(mainItems.TestPath)
        x = zeros(nrows+20,ncols+20,3)
        x(1:2:226,1:2:365,:) = 255
        x(11:end-10,11:end-10,:) = i
